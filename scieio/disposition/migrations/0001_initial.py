# Generated by Django 3.0.5 on 2020-04-21 22:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('test_semiconductor', '0001_initial'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semiconductor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='test_semiconductor.TestSemiConductor')),
            ],
            options={
                'ordering': ['id'],
